package com.proyecto.ice.servicios;
...
import com.proyecto.ice.repositorios.RepositorioUsuarios;
...
public class ServicioUsuarios {
	...
	public Usuario login(LoginUsuario datosInicioDeSesion, BindingResult result) {
        ...
        if(existeUsuario == null) {
            ...
            result.rejectValue("emailLogin", "Unique", "E-mail no esta registrado");
        } else {
