...
@Entity
@Table(name="usuarios")//Table(name="nombre de la tabla (en plural)")
public class Usuario {
	
	
	@Id //este atributo representa la llave primaria
	@GeneratedValue(strategy=GenerationType.IDENTITY)//este atributo tiene autoincremento
	private Long id;
	...
	@Transient //esta informacion no se guarda en la BD
	...
	private List<Pelicula> pelisCreador;
	
	@ManyToMany(fetch=FetchType.LAZY)
	@JoinTable(name="pelis_favoritas", 
	...
	public List<Pelicula> getPelisCreador() {
		return pelisCreador;
	}

	public void setPelisCreador(List<Pelicula> pelisCreador) {
		this.pelisCreador = pelisCreador;
	}
